                                ...
                                <div className="tpdealproduct">
                                    <div className="tpdealproduct__thumb p-relative text-center">
                                        ...
                                        <div className="tpdealproductd__offer">
                                            <h5 className="tpdealproduct__offer-price"><span>From</span>$70</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-6 col-md-12">
                                <div className="tpdealcontact pt-30">
                                    ...
                                    <div className="tpdealcontact__text mb-30">
                                        <h4 className="tpdealcontact__title mb-10"><Link href="/shop-details">La playera de tu selección</Link></h4>
                                        <p>Diversas tallas y de todos los paises participantes.</p>
                                    </div>
                                    ...
                                    <div className="tpdealcontact__count">
                                        ...
                                        <i>Queda poco tiempo <br /> Aprovecha la promoción</i>
                                    </div>
                                </div>
                            </div>
                        </div>
