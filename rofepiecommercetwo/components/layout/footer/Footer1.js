                                ...
                                <div className="col-lg-3 col-md-4 col-sm-6">
                                    <div className="footer-widget footer-col-1 mb-40">
                                        ...
                                        <div className="footer-content">
                                            <p>Trabaja con una empresa <br /> con más de 25 años de experiencia
                                                <br /> Puedes consultarnor por diferentes medios <br /> tel, redes y whatsapp.</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="row">
                                <div className="col-xl-6 col-lg-7 col-md-5 col-sm-12">
                                    <div className="footer-copyright__content">
                                        <span>Copyright {new Date().getFullYear()} <Link href="/">©ROFERPI</Link>. Derechos reservados
                                            <Link href="/"> AISolutions4U</Link>.</span>
                                    </div>
                                </div>
